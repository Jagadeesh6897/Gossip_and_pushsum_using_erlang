-module(algo_topology).
-author("Jag").
-import(lists,[nth/2, member/2]).
-export([grid_connected/3, line_connected/3, fully_connected/2, imp2D_connected/3]).
...
imp2D_connected(I, RowLength, Pids) ->
  ...
  imp2D_connected(I-1, RowLength, Pids).
